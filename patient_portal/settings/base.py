...
CELERY_TASK_TIME_LIMIT = int(env("CELERY_TASK_TIME_LIMIT", default=30))
CELERY_TASK_SOFT_TIME_LIMIT = int(env("CELERY_TASK_SOFT_TIME_LIMIT", default=25))
CELERY_WORKER_MAX_TASKS_PER_CHILD = int(env("CELERY_WORKER_MAX_TASKS_PER_CHILD", default=200))

# Dedupe window bucket (for dedupe_key)
DEDUPE_BUCKET_HOURS = int(env("DEDUPE_BUCKET_HOURS", default=1))
